...
export default function WelcomeStage({ onStart }: WelcomeStageProps) {
    ...
    return (
        <div className="fixed inset-0 bg-[#0d1117] flex items-center justify-center p-4 overflow-y-auto">
            <motion.div
            ...
            >
                {/* Terminal Window */}
                <div className="bg-[#0a0e14] border-2 border-green-500/30 rounded-lg shadow-2xl shadow-green-500/20 overflow-hidden">
                    {/* Terminal Header */}
                    <div className="bg-[#1a1f2e] border-b border-green-500/30 px-4 py-2 flex items-center gap-3">
                    ...
                    {/* Terminal Content */}
                    <div className="p-6 font-mono text-sm max-h-[70vh] overflow-y-auto [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-track]:bg-[#0a0e14] [&::-webkit-scrollbar-thumb]:bg-green-500 [&::-webkit-scrollbar-thumb]:rounded [&::-webkit-scrollbar-thumb:hover]:bg-green-600">
...
╚══════════════════════════════════════════════════════════════╝`}
                            ...
                            <div className="mt-6 pt-4 border-t border-gray-800">
                                ...
                                <motion.button
                                    ...
                                    whileTap={{ scale: 0.98 }}
                                    className="w-full bg-gradient-to-r from-green-600 to-cyan-600 hover:from-green-500 hover:to-cyan-500 text-white font-bold py-4 px-6 rounded transition-all duration-300 shadow-lg hover:shadow-green-500/50 flex items-center justify-center gap-3 group"
                                >
                                    <Play className="w-5 h-5 group-hover:animate-pulse" />
                                    <span>[ENTER] Execute Pipeline →</span>
                                </motion.button>

                                <div className="text-gray-600 text-xs text-center mt-3">
                                    Press ENTER to start the DevOps journey
                                </div>
                            </div>
                        </motion.div>
                    </div>
